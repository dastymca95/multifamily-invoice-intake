...
/**
 * Left rail of the Vendors builder workspace.
 *
 * Mirrors `GLCatalogList` and `PropertyCatalogList` so the three
 * Reference Data builders feel like one product:
 *   * top "+ New" CTA
 ...
 */
interface VendorCatalogListProps {
...
export function VendorCatalogList({
  items,
  selectedId,
  viewingDraft,
  hasDraft,
...
const SOURCE_LABEL: Record<VendorCatalogSource, string> = {
